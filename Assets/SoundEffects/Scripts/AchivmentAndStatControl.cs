...
public static class AchivmentAndStatControl
{
	...
	{
        // Per Round
        new Achievement_t(Achievement.SQUAT_CONSEC0, "Mosquito Bites", "Do 10 squats in a row in Classic Mode."),
		new Achievement_t(Achievement.SQUAT_CONSEC1, "Sugar Lumps", "Do 100 squats in a row in Classic Mode."),
		new Achievement_t(Achievement.SQUAT_CONSEC2, "Bubble Butt", "Do 200 squats in a row in Classic Mode."),
		new Achievement_t(Achievement.SQUAT_CONSEC3, "Thicc", "Do 350 squats in a row in Classic Mode."),
		new Achievement_t(Achievement.SQUAT_CONSEC4, "Dummy Thicc", "Do 500 squats in a row in Classic Mode."),

		new Achievement_t(Achievement.SQUAT_TOTAL0, "Slight Dedication", "Do 500 squats in total."),
		new Achievement_t(Achievement.SQUAT_TOTAL1, "Dedication", "Do 1,000 squats in total."),
		new Achievement_t(Achievement.SQUAT_TOTAL2, "Enthusiast", "Do 2,500 squats in total."),
		new Achievement_t(Achievement.SQUAT_TOTAL3, "Uhh Maybe You Squat Too Much...", "Do 10,000 squats in total."),
		new Achievement_t(Achievement.SQUAT_TOTAL4, "Please Stop, Think About Your Legs!", "Do 50,000 squats in total."),

		new Achievement_t(Achievement.DAILY_CHALLENGE0, "Leg Day", "Complete 1 daily challenge."),
		new Achievement_t(Achievement.DAILY_CHALLENGE1, "Leg Week", "Complete 7 daily challenge."),
		new Achievement_t(Achievement.DAILY_CHALLENGE2, "Leg Fortnight", "Complete 14 daily challenge."),
		new Achievement_t(Achievement.DAILY_CHALLENGE3, "Leg Month", "Complete 30 daily challenge."),
		new Achievement_t(Achievement.DAILY_CHALLENGE4, "Leg Life", "Complete 50 daily challenge."),
		new Achievement_t(Achievement.DAILY_CHALLENGE5, "Upper Body? Never Heard of it.", "Complete 100 daily challenge."),
...
public static class Constants
{
	...
	public static string song80s = "80s";
	public static string songInHouse = "In-House";
	public static string songNewGlory = "New Glory";
	public static string songSco2 = "Sco 2";
	public static string songTheSeparation = "The Separation";
