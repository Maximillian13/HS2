...
public class BreakOptionsButton : MonoBehaviour, IInteractibleButton
{
	public bool xSecondBreak;
	...
	public void Select()
	{
		// Clear the correct buttons 
		if(xSecondBreak == true)
			master.DeselectAllXSecondButtons();
		else
			master.DeselectAllEveryXWallsButtons();
