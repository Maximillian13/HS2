...
public class SteamLeaderBoardUpdater : MonoBehaviour
{
	...
	//		if (SteamManager.Initialized == true)
	//		{
	//			SteamAPICall_t handle = SteamUserStats.UploadLeaderboardScore(m_SteamLeaderboard, ELeaderboardUploadScoreMethod.k_ELeaderboardUploadScoreMethodKeepBest, (int)100, null, 0);
	...
	//public void UpdateLeaderBoard(int numberOfSquats)
	//{
	//	if (SteamManager.Initialized == true)
	//	{
	//		SteamAPICall_t handle = SteamUserStats.UploadLeaderboardScore(m_SteamLeaderboard, ELeaderboardUploadScoreMethod.k_ELeaderboardUploadScoreMethodKeepBest, (int)numberOfSquats, null, 0);
	//		LeaderboardScoreUploaded.Set(handle);
	//		Debug.Log("Scores uploaded");
	//		SteamAPI.RunCallbacks();
	//	}
