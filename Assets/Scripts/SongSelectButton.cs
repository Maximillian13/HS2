...
public class SongSelectButton : MonoBehaviour, IInteractibleButton
{
	...
	private SongSelectButtonControl master;
	...
	void Start()
	{
		...
		mr.enabled = false;
		master = this.transform.parent.parent.GetComponent<SongSelectButtonControl>();
	}
	...
	/// <summary>
	/// Returns the name of the song that is associated with this button
	/// </summary>
